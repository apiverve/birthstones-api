...
namespace APIVerve.API.Birthstones
{
    ...
    /// <summary>
    /// Client for the Birthstones API
    /// </summary>
    public class BirthstonesAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/birthstones";
        ...
        {
            { "month", new ValidationRule { Type = "string", Required = true } }
        };
        ...
        public BirthstonesAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public BirthstonesAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public BirthstonesAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, BirthstonesQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(BirthstonesQueryOptions options)
        {
        ...
        public ResponseObj Execute(BirthstonesQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(BirthstonesQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(BirthstonesQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(BirthstonesQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(BirthstonesQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(BirthstonesQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(BirthstonesQueryOptions options)
        {
