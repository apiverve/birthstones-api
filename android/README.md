...
```gradle
dependencies {
    implementation 'com.github.apiverve:birthstones-api:1.1.14'
}
```
...
```java
import com.apiverve.birthstones.BirthstonesAPIClient;
import com.apiverve.birthstones.APIResponse;
import com.apiverve.birthstones.APIException;

// Initialize the client
BirthstonesAPIClient client = new BirthstonesAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("month", "5");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/birthstones](https://docs.apiverve.com/ref/birthstones)
...
- **Documentation:** [https://docs.apiverve.com/ref/birthstones](https://docs.apiverve.com/ref/birthstones)
- **Issues:** [GitHub Issues](https://github.com/apiverve/birthstones-api/issues)
