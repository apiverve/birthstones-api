// Package birthstones provides a Go client for the Birthstones API.
//
// For more information, visit: https://apiverve.com/marketplace/birthstones?utm_source=go&utm_medium=readme
package birthstones
...
// Request contains the parameters for the Birthstones API.
//
// Parameters:
//   - month (required): string - The month number (1-12) or name
type Request struct {
...
// ResponseData contains the data returned by the Birthstones API.
type ResponseData struct {
	Month int `json:"month"`
	MonthName string `json:"monthName"`
	PrimaryStone string `json:"primaryStone"`
	AlternateStones []string `json:"alternateStones"`
	Color string `json:"color"`
	Meaning string `json:"meaning"`
	ZodiacSigns []string `json:"zodiacSigns"`
	Hardness float64 `json:"hardness"`
	MineralFamily string `json:"mineralFamily"`
	AnniversaryYear int `json:"anniversaryYear"`
}
