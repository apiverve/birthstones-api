...
const (
	baseURL        = "https://api.apiverve.com/v1/birthstones"
	defaultTimeout = 30 * time.Second
)

// Client is the Birthstones API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Birthstones API client.
...
// Execute makes a request to the Birthstones API with typed parameters.
//
