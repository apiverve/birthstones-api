...
namespace APIVerve\Birthstones;
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/birthstones?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/birthstones';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\BirthstonesClient] {$message}\n";
        }
    }
}
